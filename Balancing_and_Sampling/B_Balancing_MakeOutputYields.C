...
int B_Balancing_MakeOutputYields(Int_t Nbatch, const char* path_bb, const char* path_bb_JUNCTIONS, const char* path_cc, const char* path_cc_JUNCTIONS, const char* path_cc_prompt, const char* path_cc_prompt_JUNCTIONS, const char* path_cc_non_prompt, const char* path_cc_non_prompt_JUNCTIONS) {
  ...
  vPathAndLabels.push_back({"MONASH", -1, -1, -1, path_bb});
  ...
  // *** LegendTitle, Color, LineStyle, LineWidth, PathName ***
  vPathAndLabels.push_back({" ", kBlack, -1, -1, path_bb});
  vPathAndLabels.push_back({" ", kRed, -1, -1, path_bb_JUNCTIONS});
  ...
  vInput = configureInputMult(vPathAndLabels, vRootFileAndLabels, vHistNameAndLabels);
  TTree* bb_J_MULT_CONDENSED_tree = CalculateOS_minus_SS(Nbatch, "BBMULTCONDENSED", vInput, "integrated yields for B^{+} trigger as function of multiplicity condensed", 3*vPathAndLabels.size(), junctions, division, write);
  outputFile->cd();
  ...
  // *** LegendTitle, Color, LineStyle, LineWidth, PathName ***
  vPathAndLabels.push_back({" ", kBlack, -1, -1, path_cc});
  vPathAndLabels.push_back({" ", kRed, -1, -1, path_cc_JUNCTIONS});
  ...
  if (cc_JUNCTIONS_MULTIPLICITY_CONDENSED) {
    vInput = configureInputMult(vPathAndLabels, vRootFileAndLabels, vHistNameAndLabels);
    TTree* cc_J_MULT_CONDENSED_tree = CalculateOS_minus_SS(Nbatch, "CCMULTCONDENSED", vInput, "integrated yields for D^{+} trigger as function of multiplicity", 3*vPathAndLabels.size(), junctions, write);
    outputFile->cd();
  ...
  // *** LegendTitle, Color, LineStyle, LineWidth, PathName ***
  vPathAndLabels.push_back({" ", kBlack, -1, -1, path_cc_prompt});
  vPathAndLabels.push_back({" ", kRed, -1, -1, path_cc_prompt_JUNCTIONS});
  ...
  vInput = configureInputMult(vPathAndLabels, vRootFileAndLabels, vHistNameAndLabels);
  TTree* cc_prompt_J_MULT_CONDENSED_tree = CalculateOS_minus_SS(Nbatch, "CCPROMPTMULTCONDENSED", vInput, "integrated yields for prompt D^{+} trigger as function of multiplicity", 3*vPathAndLabels.size(), junctions, division, write);
  outputFile->cd();
  ...
  // *** LegendTitle, Color, LineStyle, LineWidth, PathName ***
  vPathAndLabels.push_back({" ", kBlack, -1, -1, path_cc_non_prompt});
  vPathAndLabels.push_back({" ", kRed, -1, -1, path_cc_non_prompt_JUNCTIONS});
  ...
  vInput = configureInput(vPathAndLabels, vRootFileAndLabels, vHistNameAndLabels);
  TTree* cc_non_prompt_J_MULT_GENERAL_tree = CalculateOS_minus_SS(Nbatch, "CCNONPROMPTMULTGENERAL", vInput, "integrated yields for non-prompt D^{+} trigger as function of multiplicity", vHistNameAndLabels.size()*vPathAndLabels.size(), junctions, division, write);
  outputFile->cd();
  ...
  vInput = configureInputMult(vPathAndLabels, vRootFileAndLabels, vHistNameAndLabels);
  TTree* cc_non_prompt_J_MULT_CONDENSED_tree = CalculateOS_minus_SS(Nbatch, "CCNONPROMPTMULTCONDENSED", vInput, "integrated yields for non-prompt D^{+} trigger as function of multiplicity", 3*vPathAndLabels.size(), junctions, division, write);
  outputFile->cd();
