...
{
//=========Macro generated from canvas: c2x2_yields/balancing yields for beauty and charm on a 2x2 canvas
//=========  (Thu May 30 09:11:42 2024) by ROOT version 6.28/04
   TCanvas *c2x2_yields = new TCanvas("c2x2_yields", "balancing yields for beauty and charm on a 2x2 canvas",120,64,1200,1000);
   c2x2_yields->Range(0,0,1,1);
   c2x2_yields->SetFillColor(0);
   c2x2_yields->SetBorderMode(0);
   c2x2_yields->SetBorderSize(2);
   c2x2_yields->SetRightMargin(0.05);
   c2x2_yields->SetBottomMargin(0.05);
   c2x2_yields->SetFrameBorderMode(0);
...
// ------------>Primitives in pad: c21mini_yields
   ...
   c2x2_yields->cd();
   c2x2_yields->Modified();
   c2x2_yields->cd();
   c2x2_yields->SetSelected(c2x2_yields);
}
