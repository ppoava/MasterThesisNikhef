// SameDiffMother_Markers_MotherStudy.C
...
void readTree(vector<const char*> DPhi2DVector,
  ...
  // hDMesonsRaw->SetTitle(Form("Trigger mothers %s", ptRegion));
  hDMesonsRaw->SetTitle("");
  hDMesonsRaw->GetYaxis()->SetTitle("#frac{1}{N_{trigger}} #frac{dN}{d#Delta#phi}");
  hDMesonsRaw->GetXaxis()->SetTitle("#Delta#phi (trigger mother, associate mother)");
  hDMesonsRaw->SetStats(0);
  ...
  hBMesonsChargedRaw->Draw("same APE");
  ...
  if (stackedYmin != 0) {
    hDMesonsRaw->GetYaxis()->SetRangeUser(stackedYmin, stackedYmax);
  }
  ...
  legendStacked->AddEntry(hDMesonsRaw, "excited d-mesons", "P");
  ...
  hBBaryonsRaw->Draw("same PE");
  
  if (stackedYmin != 0) {
    hDMesonsRaw->GetYaxis()->SetRangeUser(stackedYmin, stackedYmax);
  }

  TLegend *legendStackedSelection = new TLegend(legendXmin, legendYmin-0.19, legendXmax, legendYmax);
  legendStackedSelection->SetBorderSize(0);
  legendStackedSelection->SetTextSize(0.03);
  legendStackedSelection->AddEntry(hDMesonsRaw, "excited d-mesons", "P");
  ...
  if (write) {
    cBMesons->SaveAs(Form("Plots/DecayOnly/MarkerscBMesonsTr_%s_%s.pdf", ptRegion, ptTrRegion));
    cStacked->SaveAs(Form("Plots/DecayOnly/MarkerscStackedTr_%s_%s.pdf", ptRegion, ptTrRegion));
    cStackedSelection->SaveAs(Form("Plots/DecayOnly/MarkerscStackedSelectionTr_%s_%s.pdf", ptRegion, ptTrRegion));
  }
  ...
  legendBMesons->SetBorderSize(0);
  legendBMesons->SetTextSize(0.03);
  legendBMesons->AddEntry(hADMesonsRel, "excited anti-d-mesons");
  legendBMesons->AddEntry(hBpRel, hBpRel->GetTitle());
  legendBMesons->AddEntry(hBmRel, hBmRel->GetTitle());
  legendBMesons->AddEntry(hB0Rel, hB0Rel->GetTitle());
  legendBMesons->AddEntry(hAB0Rel, hAB0Rel->GetTitle());
  ...
  hBMesonsChargedRaw->GetXaxis()->SetTitle("#Delta#phi (trigger mother, associate mother)");
  ...
  legendStacked->SetBorderSize(0);
  legendStacked->SetTextSize(0.03);
  legendStacked->AddEntry(hADMesonsRaw, "excited anti-d-mesons", "P");
  legendStacked->AddEntry(hBMesonsNeutralRaw, hBMesonsNeutralRaw->GetTitle(), "P");
  legendStacked->AddEntry(hBMesonsChargedRaw, "b-mesons (charged)", "P");
  legendStacked->Draw();
  ...
  hBBaryonsRaw->GetXaxis()->SetTitle("#Delta#phi (trigger mother, associate mother)");
  ...
  legendStackedSelection->SetBorderSize(0);
  legendStackedSelection->SetTextSize(0.03);
  legendStackedSelection->AddEntry(hADMesonsRaw, "excited anti-d-mesons", "P");
  legendStackedSelection->AddEntry(hBpRaw, hBpRaw->GetTitle(), "P");
  legendStackedSelection->AddEntry(hBmRaw, hBmRaw->GetTitle(), "P");
  legendStackedSelection->AddEntry(hB0Raw, hB0Raw->GetTitle(), "P");
  legendStackedSelection->AddEntry(hAB0Raw, hAB0Raw->GetTitle(), "P");
  ...
  if (write) {
    cBMesons->SaveAs(Form("Plots/DecayOnly/MarkerscBMesonsAs_%s_%s.pdf", ptRegion, ptTrRegion));
    cStacked->SaveAs(Form("Plots/DecayOnly/MarkerscStackedAs_%s_%s.pdf", ptRegion, ptTrRegion));
    cStackedSelection->SaveAs(Form("Plots/DecayOnly/MarkerscStackedSelectionAs_%s_%s.pdf", ptRegion, ptTrRegion));
  }
...
int SameDiffMother_Markers_MotherStudy() {
